...
##### load plots
#strength_duration_curve = plt.imread(f"test_battery_results/{model.display_name}/Strength_duration_curve {model.display_name}.eps")
#plt.imshow(strength_duration_curve)
...
relative_refractory_periods["RRP Experiments (ms)"] = ["-","3-4\n4-5","5","-","5"]
relative_refractory_periods["reference"] = ["-","Stypulkowski and Van den Honert 1984\nCartee et al. 2000","Dynes 1996","-", "Hartmann et al. 1984"]
