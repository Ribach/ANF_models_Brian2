...
{\color{incolor}In [{\color{incolor}116}]:} \PY{k+kn}{from} \PY{n+nn}{IPython}\PY{n+nn}{.}\PY{n+nn}{display} \PY{k}{import} \PY{n}{HTML}
          ...
          \PY{l+s+s1}{Show/hide the code by clicking \PYZlt{}a href=}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{javascript:code\PYZus{}toggle()}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZgt{}here\PYZlt{}/a\PYZgt{}.}\PY{l+s+s1}{\PYZsq{}\PYZsq{}\PYZsq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}116}]:} <IPython.core.display.HTML object>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}117}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
          ...
          \PY{n}{strength\PYZus{}duration\PYZus{}data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{model}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}.3g}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}}\PY{k}{strength\PYZus{}duration\PYZus{}data}[\PYZdq{}model\PYZdq{}][i] for i in range(0,2)]
          ...
          \PY{k}{if} \PY{n+nb}{hasattr}\PY{p}{(}\PY{n}{model}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{index\PYZus{}soma}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{:}
              ...
              \PY{n}{conduction\PYZus{}velocity\PYZus{}table}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Czèh et al 1976}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{v\PYZus{}ax = 0.9*v\PYZus{}den\PYZhy{}6.9*m/s}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
          ...
          \PY{n}{latency\PYZus{}jitter}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{value}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}.3g}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}}\PY{k}{latency\PYZus{}jitter}[\PYZdq{}value\PYZdq{}][i] for i in range(0,latency\PYZus{}jitter.shape[0])]
          \PY{n}{latency\PYZus{}jitter}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{phase duration (us)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}g}\PY{l+s+s2}{ us}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}}\PY{k}{latency\PYZus{}jitter}[\PYZdq{}phase duration (us)\PYZdq{}][i] for i in range(0,latency\PYZus{}jitter.shape[0])]
          \PY{n}{latency\PYZus{}jitter} \PY{o}{=} \PY{n}{latency\PYZus{}jitter}\PY{o}{.}\PY{n}{rename}\PY{p}{(}\PY{n}{index} \PY{o}{=} \PY{n+nb}{str}\PY{p}{,} \PY{n}{columns}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{phase duration (us)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{phase duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{\PYZcb{}}\PY{p}{)}
          ...
          \PY{n}{latency\PYZus{}jitter} \PY{o}{=} \PY{n}{latency\PYZus{}jitter}\PY{o}{.}\PY{n}{sort\PYZus{}values}\PY{p}{(}\PY{n}{by}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{pulse form}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{phase duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{ascending} \PY{o}{=} \PY{p}{[}\PY{k+kc}{False}\PY{p}{,} \PY{k+kc}{True}\PY{p}{]}\PY{p}{)}
          ...
          \PY{n}{latency\PYZus{}jitter} \PY{o}{=} \PY{n}{latency\PYZus{}jitter}\PY{o}{.}\PY{n}{rename}\PY{p}{(}\PY{n}{index} \PY{o}{=} \PY{n+nb}{str}\PY{p}{,} \PY{n}{columns}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{variable}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{property}\PY{l+s+s2}{\PYZdq{}}\PY{p}{\PYZcb{}}\PY{p}{)}
          \PY{n}{latency\PYZus{}jitter} \PY{o}{=} \PY{n}{latency\PYZus{}jitter}\PY{o}{.}\PY{n}{set\PYZus{}index}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{phase duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{pulse form}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{property}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}118}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{HTML}
          \PYZlt{}style type=\PYZdq{}text/css\PYZdq{}\PYZgt{}
          table.dataframe td, table.dataframe th \PYZob{}
              border\PYZhy{}right: 1px  black solid !important;
              text\PYZhy{}align: center !important;
...
<IPython.core.display.HTML object>
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}119}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZsh{} }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{: Test battery results}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{model}\PY{o}{.}\PY{n}{display\PYZus{}name}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
results}\label{rattay-et-al.-2001-test-battery-results}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}120}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{![title](}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{?arg)}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{strength\PYZus{}duration\PYZus{}curve\PYZus{}link}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\texttt{\color{outcolor}Out[{\color{outcolor}120}]:}
    ...
    \begin{figure}
\centering
\includegraphics{test_battery_results/Rattay et al. 2001/Strength_duration_curve Rattay et al. 2001.png?arg}
\caption{title}
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}121}]:} \PY{n}{strength\PYZus{}duration\PYZus{}data}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}121}]:}                 model Van den Honert and Stypulkowski 1984
...
thresholds}\label{relative-spread-of-thresholds}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}122}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{![title](}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{?arg)}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{relative\PYZus{}spread\PYZus{}plot\PYZus{}link}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\texttt{\color{outcolor}Out[{\color{outcolor}122}]:}
    ...
    \begin{figure}
\centering
\includegraphics{test_battery_results/Rattay et al. 2001/Relative_spreads_plot Rattay et al. 2001.png?arg}
\caption{title}
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}123}]:} \PY{n}{relative\PYZus{}spreads}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}123}]:}                             model experiments           reference
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}124}]:} \PY{n}{conduction\PYZus{}velocity\PYZus{}table}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}124}]:}                              model Hursh 1939 Boyd and Kalu 1979           Czèh et al 1976
          velocity dendrite (m/s)      6.839          -                  -                         -
          velocity/diameter dendrite   4.070          6                4.6                         -
          velocity axon (m/s)         12.840          -                  -  v\_ax = 0.9*v\_den-6.9*m/s
...
properties}\label{single-node-response-properties}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}125}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{![title](}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{?arg)}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{single\PYZus{}node\PYZus{}response\PYZus{}link}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\texttt{\color{outcolor}Out[{\color{outcolor}125}]:}
    ...
    \begin{figure}
\centering
\includegraphics{test_battery_results/Rattay et al. 2001/Single_node_response Rattay et al. 2001.png?arg}
\caption{title}
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}126}]:} \PY{n}{AP\PYZus{}shape}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}126}]:}                       model Paintal 1965
          AP height (mV)    87.182752            -
          rise time (ms)     0.111750        0.136
          fall time (ms)     0.192500        0.379
          AP duration (ms)   0.304737        0.515
\end{Verbatim}
            
    \subsubsection{4.2 Latency and jitter}\label{latency-and-jitter}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}127}]:} \PY{n}{latency\PYZus{}jitter}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}127}]:}                                        model (threshold) model (2*threshold) Miller et al. 1999  \textbackslash{}
          phase duration pulse form property                                                                
          100 us         monophasic latency (us)               461                 132                650   
                                    jitter (us)                121                3.35                100   
          40 us          monophasic latency (us)               398                93.5                  -   
                                    jitter (us)                108                2.35                  -   
          50 us          monophasic latency (us)               360                 100                  -   
                                    jitter (us)                115                2.29                  -   
          200 us         biphasic   latency (us)               375                 171                  -   
                                    jitter (us)               97.7                4.55                  -   
          ...
          200 us         biphasic   latency (us)                                                -   
                                    jitter (us)                                                 -   
                                                 ...
                                                 Van den Honert and Stypulkowski 1984 (2*threshold) Hartmann and al. 1984  \textbackslash{}
          phase duration pulse form property                                                                                
          100 us         monophasic latency (us)                                                  -                     -   
                                    jitter (us)                                                   -                     -   
          40 us          monophasic latency (us)                                                  -                     -   
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}128}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{![title](}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{?arg)}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{refractory\PYZus{}curve\PYZus{}link}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\texttt{\color{outcolor}Out[{\color{outcolor}128}]:}
    ...
    \begin{figure}
\centering
\includegraphics{test_battery_results/Rattay et al. 2001/Refractory_curve Rattay et al. 2001.png?arg}
\caption{title}
\end{figure}
...
periods}\label{absolute-refractory-periods}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}129}]:} \PY{n}{absolute\PYZus{}refractory\PYZus{}periods}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}129}]:}                                 ARP model (us) ARP Experiments (us)                             reference
...
periods}\label{relative-refractory-periods}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}130}]:} \PY{n}{relative\PYZus{}refractory\PYZus{}periods}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}130}]:}                                 RRP model (ms) RRP Experiments (ms)  \textbackslash{}
          phase duration (us) pulse form                                        
...
histogramm}\label{post-stimulus-time-histogramm}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}131}]:} \PY{n}{md}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{![title](}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s2}{?arg)}\PY{l+s+s2}{\PYZdq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{post\PYZus{}stimulus\PYZus{}time\PYZus{}histogram\PYZus{}link}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
