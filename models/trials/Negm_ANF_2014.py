...
gamma_K = 50*psiemens
gamma_KLT = 13*psiemens *0
gamma_HCN = 13*psiemens *0
...
gamma_KLT_terminal = gamma_KLT / dividing_factor_conductances *0
gamma_HCN_terminal = gamma_HCN / dividing_factor_conductances *0
...
#c_m[0:start_index_soma][structure[0:start_index_soma] == 1] = (2*e_0*e_r*np.pi*(length_internodes_dendrite/nof_segments_internodes))/np.log(dendrite_outer_diameter/diameter_dendrite)
#c_m[end_index_soma+1:][structure[end_index_soma+1:] == 1] = (2*e_0*e_r*np.pi*(length_internodes_dendrite/nof_segments_internodes))/np.log(axon_outer_diameter/diameter_axon)
#
## somatic region
