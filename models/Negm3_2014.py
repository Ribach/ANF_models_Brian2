...
##### dividing factor for conductances of peripheral terminal and somatic region
dividing_factor_conductivities = 15
...
##### deviding factor for somatic region
...
structure = np.array([0] + list(np.tile(np.tile([1],nof_segments_internodes).tolist() + [2],5)) +
...
# somatic region
c_m[np.where(np.logical_or(structure == 3, structure == 4))] = c_m_axolemma/dividing_factor_capacitances
...
gamma_Na_vector[structure == 0] = gamma_Na / dividing_factor_conductivities
gamma_Na_vector[structure == 3] = gamma_Na / dividing_factor_conductivities
gamma_Na_vector[structure == 4] = gamma_Na / dividing_factor_conductivities
...
def set_up_model(dt, model, update = False, model_name = "model"):
    ...
    neuron.gamma_Na[np.where(model.structure == 0)[0]] = model.gamma_Na / model.dividing_factor_conductivities
    neuron.gamma_K[np.where(model.structure == 0)[0]] = model.gamma_K / model.dividing_factor_conductivities
    neuron.gamma_KLT[np.where(model.structure == 0)[0]] = model.gamma_KLT / model.dividing_factor_conductivities
    neuron.gamma_HCN[np.where(model.structure == 0)[0]] = model.gamma_HCN / model.dividing_factor_conductivities
    neuron.g_L[np.where(model.structure == 0)[0]] = model.g_L / model.dividing_factor_conductivities
    
    # conductances presomatic region and soma
    neuron.gamma_Na[np.asarray(np.where(np.logical_or(model.structure == 3, model.structure == 4)))] = model.gamma_Na / model.dividing_factor_conductivities
    neuron.gamma_K[np.asarray(np.where(np.logical_or(model.structure == 3, model.structure == 4)))] = model.gamma_K / model.dividing_factor_conductivities
    neuron.gamma_KLT[np.asarray(np.where(np.logical_or(model.structure == 3, model.structure == 4)))] = model.gamma_KLT / model.dividing_factor_conductivities
    neuron.gamma_HCN[np.asarray(np.where(np.logical_or(model.structure == 3, model.structure == 4)))] = model.gamma_HCN / model.dividing_factor_conductivities
    neuron.g_L[np.asarray(np.where(np.logical_or(model.structure == 3, model.structure == 4)))] = model.g_L / model.dividing_factor_conductivities
